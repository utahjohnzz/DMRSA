...
plt.plot(abang,indexw,label='MGMH DMRSA DW',color='#7C7DE3',marker='o',markersize=1)
plt.plot(abang,indexb,color='b',marker='o',label='MGMH DMRSA',markersize=1)
...
erdw=np.zeros((0,0))
for i in mgmhy2:
    er=indexb[countz]-mgmhy2[countz]
    erndw=np.append(erndw,er)
    er=indexw[countz]-mgmhy2[countz]
    erdw=np.append(erdw,er)
    countz+=1
print('Error in Average Moment arm for no Deltoid Wrapping for MGMH:',np.average(mgmhy2)-np.average(indexb))
print('Error in Average Moment arm for Deltoid Wrapping for MGMH:',np.average(mgmhy2)-np.average(indexw))
...
abang=np.linspace(0,abrange,step)
plt.plot(abang,indexw,label='LGMH DMRSA DW',color='#47C062',marker='^',markersize=1)
plt.plot(abang,indexb,color='g',marker='^',label='LGMH DMRSA',markersize=1)
...
erdw=np.zeros((0,0))
for i in mgmhy2:
    er=indexb[countz]-lgmhy2[countz]
    erndw=np.append(erndw,er)
    er=indexw[countz]-lgmhy2[countz]
    erdw=np.append(erdw,er)
    countz+=1
print('Error in Average Moment arm for no Deltoid Wrapping for LGMH:',np.average(lgmhy2)-np.average(indexb))
print('Error in Average Moment arm for Deltoid Wrapping for LGMH:',np.average(lgmhy2)-np.average(indexw))
...
abang=np.linspace(0,abrange,step)
plt.plot(abang,indexw,label='MGLH DMRSA DW',color='#C86262',marker='s',markersize=1)
plt.plot(abang,indexb,color='r',marker='^',label='MGLH DMRSA',markersize=1)
...
countz=0
for i in mgmhy2:
    er=indexb[countz]-mglhy2[countz]
    erndw=np.append(erndw,er)
    er=indexw[countz]-mglhy2[countz]
    erdw=np.append(erdw,er)
    countz+=1
print('Error in Average Moment arm for no Deltoid Wrapping for MGLH:',np.average(mglhy2)-np.average(indexb))
print('Error in Average Moment arm for Deltoid Wrapping for MGLH:',np.average(mglhy2)-np.average(indexw))
